...
void ed25519_sign(unsigned char *sig, const unsigned char *msg, unsigned long long msglen, const unsigned char *pk, const unsigned char *sk) {
    sha_context ctx;
    unsigned char az[64];
...
int ed25519_verify(const unsigned char *sig, const unsigned char *msg, unsigned long long msglen, const unsigned char *pk) {
    sha_context ctx;
