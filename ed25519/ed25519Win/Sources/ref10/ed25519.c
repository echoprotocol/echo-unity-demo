...
ED25519_EXPORT void ed25519_sign(unsigned char *sig, const unsigned char *msg,
...
ED25519_EXPORT int ed25519_verify(const unsigned char *sig, const unsigned char *msg,
        unsigned long long msglen, const unsigned char *pk) {
    sha_context ctx;
