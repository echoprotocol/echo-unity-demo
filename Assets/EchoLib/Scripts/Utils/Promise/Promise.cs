...
namespace Promises
{
    ...
    public class Promise : IPromise, IPendingPromise, IPromiseInfo
    {
        ...
        {
            (resolveHandlers ?? (resolveHandlers = new List<ResolveHandler>())).Add(new ResolveHandler { callback = onResolved, rejectable = rejectable });
        }
        ...
        /// onRejected is called on error.
        /// </summary>
        public void Done(Action onResolved, Action<Exception> onRejected) => Then(onResolved, onRejected).Catch(ex => PropagateUnhandledException(this, ex));
        ...
        /// Adds a default error handler.
        /// </summary>
        public void Done(Action onResolved) => Then(onResolved).Catch(ex => PropagateUnhandledException(this, ex));

        /// <summary>
        /// Complete the promise. Adds a defualt error handler.
        /// </summary>
        public void Done() => Catch(ex => PropagateUnhandledException(this, ex));
        ...
        /// Add a resolved callback that chains a value promise (optionally converting to a different value type).
        /// </summary>
        public IPromise<ConvertedT> Then<ConvertedT>(Func<IPromise<ConvertedT>> onResolved) => Then(onResolved, null);
        ...
        /// It is rejected as soon as any of the promises have been rejected.
        /// </summary>
        public IPromise<IEnumerable<ConvertedT>> ThenAll<ConvertedT>(Func<IEnumerable<IPromise<ConvertedT>>> chain) => Then(() => Promise<ConvertedT>.All(chain()));
        ...
        /// Returns a promise that resolves when the first of the promises has resolved.
        /// </summary>
        public IPromise<ConvertedT> ThenRace<ConvertedT>(Func<IEnumerable<IPromise<ConvertedT>>> chain) => Then(() => Promise<ConvertedT>.Race(chain()));
