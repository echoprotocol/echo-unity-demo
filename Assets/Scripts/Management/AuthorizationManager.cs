...
public sealed class AuthorizationManager : CustomTools.Singleton.SingletonMonoBehaviour<AuthorizationManager>
{
    ...
    {
        EchoApiManager.OnDatabaseApiInitialized += EchoApiManager_OnDatabaseApiInitialized;
        base.Awake();
    }
    ...
    {
        return EchoApiManager.Instance.Database.GetFullAccount(userName.Trim(), false).Then(result =>
        {
