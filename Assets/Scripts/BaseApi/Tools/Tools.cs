...
namespace Tools
{
    ...
    public static class Tool
    {
        ...
        public static void PrintException(string tag, Exception ex)
        {
            ...
            {
                builder.Append(CustomTools.Console.SetGreenColor(tag));
                builder.Append(' ');
            }
            builder.Append(ex.GetType().Name);
            builder.Append('\n');
            builder.Append(CustomTools.Console.SetYellowColor("Message"));
            builder.Append(": ");
            builder.Append(ex.Message);
            if (!ex.StackTrace.IsNullOrEmpty())
            {
                builder.Append('\n');
                builder.Append(CustomTools.Console.SetRedColor("StackTrace"));
                builder.Append(": ");
            ...
            CustomTools.Console.Error(builder.ToString());
        }
    }
