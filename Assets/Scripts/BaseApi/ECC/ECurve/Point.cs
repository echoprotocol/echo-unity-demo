...
namespace ECurve
{
    public class Point : IEquatable<Point>
    {
        ...
        public BigInteger Z => z;

        public BigInteger AffineX => x.Multiply(ZInv).Modulo(curve.P);
        ...
        public override string ToString() => curve.IsInfinity(this) ? "(INFINITY)" : "(" + AffineX + "," + AffineY + ")";
    }
}