...
namespace Base.ECC
{
    public sealed class PrivateKey
    {
        ...
        private Point ToPublicKeyPoint() => Curve.SecP256k1.G.Multiply(d);

        public PublicKey ToPublicKey() => publicKey ?? (publicKey = PublicKey.FromPoint(ToPublicKeyPoint()));
        ...
        private PrivateKey Child(byte[] offset)
        {
