...
{
    public sealed class AssetIssueOperationFeeParametersData : FeeParametersData
    {
        ...
        public override ChainTypes.FeeParameters Type => ChainTypes.FeeParameters.AssetIssueOperation;
        ...
        public static AssetIssueOperationFeeParametersData Create(JObject value)
        {
            var token = value.Root;
            var instance = new AssetIssueOperationFeeParametersData();
