...
{
    public sealed class ProposalUpdateOperationFeeParametersData : FeeParametersData
    {
        ...
        public override ChainTypes.FeeParameters Type => ChainTypes.FeeParameters.ProposalUpdateOperation;
        ...
        public static ProposalUpdateOperationFeeParametersData Create(JObject value)
        {
            var token = value.Root;
            var instance = new ProposalUpdateOperationFeeParametersData();
