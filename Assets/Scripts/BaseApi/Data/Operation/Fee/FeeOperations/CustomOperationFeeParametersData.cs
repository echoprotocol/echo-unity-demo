...
{
    public sealed class CustomOperationFeeParametersData : FeeParametersData
    {
        ...
        public override ChainTypes.FeeParameters Type => ChainTypes.FeeParameters.CustomOperation;
        ...
        public static CustomOperationFeeParametersData Create(JObject value)
        {
            var token = value.Root;
            var instance = new CustomOperationFeeParametersData();
