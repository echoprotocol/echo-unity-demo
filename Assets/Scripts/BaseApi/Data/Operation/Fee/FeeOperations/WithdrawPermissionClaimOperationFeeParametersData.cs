...
{
    public sealed class WithdrawPermissionClaimOperationFeeParametersData : FeeParametersData
    {
        ...
        public override ChainTypes.FeeParameters Type => ChainTypes.FeeParameters.WithdrawPermissionClaimOperation;
        ...
        public static WithdrawPermissionClaimOperationFeeParametersData Create(JObject value)
        {
            var token = value.Root;
            var instance = new WithdrawPermissionClaimOperationFeeParametersData();
