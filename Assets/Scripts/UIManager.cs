...
public class UIManager : MonoBehaviour
{
    ...
    private class WifContainer : IWif
    {
        private string wif;
    ...
    [SerializeField] private InputField wifInputField;
    ...
    {
        loginButton.interactable = false;
        EchoApiManager.Instance.Authorization.AuthorizationBy(loginInputField.text, new WifContainer(wifInputField.text)).Then(result =>
        {
            loginButton.interactable = true;
